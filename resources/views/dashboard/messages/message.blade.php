    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('admin-panel.messages') }}" class="btn btn-secondary btn-sm font-weight-bold text-light"> <i class="fa fa-arrow-left"></i> Back </a>
                </div>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('admin-panel.message.send')}}" method="post">
                        @csrf
